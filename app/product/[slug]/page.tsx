          ...
          <div>
            ...
            <div className="mb-4 p-3 bg-primary/5 rounded-lg border border-primary/20">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <h3 className="text-sm font-bold text-primary mb-0.5">Exklusive Rezepte enthalten!</h3>
                  <p className="text-xs text-primary-dark/70 leading-relaxed">
                    Mit diesem Kauf erhalten Sie Zugang zu exklusiven griechischen Rezepten.
                  </p>
                </div>
              </div>
            </div>
