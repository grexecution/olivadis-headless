  ...
  return (
    <div className={`bg-gradient-to-br from-primary/5 to-primary/10 rounded-md p-2 lg:p-3 border border-primary/10 ${className}`}>
      ...
      <div className="flex items-center gap-1.5 mb-1.5">
        <Truck className="w-3.5 h-3.5 lg:w-3 lg:h-3 text-primary" />
        <h3 className=" lg:text-xs font-semibold text-primary">Voraussichtliche Lieferung</h3>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        {!isPastCutoff && (
          <div className="flex items-center gap-1.5 bg-white/50 rounded p-1.5">
            <Clock className="w-3.5 h-3.5 lg:w-3 lg:h-3 text-primary animate-pulse flex-shrink-0" />
            <div className="flex-1 min-w-0">
              <p className="text-[9px] lg:text-[9px] text-primary/70 leading-tight">Bestellen innerhalb</p>
              <p className="text-sm lg:text-sm font-bold text-primary tabular-nums">{timeRemaining}</p>
            </div>
          </div>
        )}
        ...
        <div className="flex items-center gap-1.5 bg-white/50 rounded p-1.5">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[9px] lg:text-[9px] text-primary/70 leading-tight">
              Voraussichtlich bei Ihnen am
            </p>
            <p className="text-[11px] lg:text-xs font-bold text-primary truncate">{estimatedDelivery}</p>
          </div>
        </div>

        {/* Disclaimer - more detailed */}
        <p className="text-[9px] lg:text-[9px] text-primary/50 text-center leading-tight px-1">
          {isPastCutoff
